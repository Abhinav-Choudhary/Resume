...
import headerData from './HeaderData-old';
import Logo from "./../images/PassportPhoto.jpg";

function HeaderOld( { navigation, isDarkMode, toggleDarkMode } ) {
    ...
    <header className={`header ${isDarkMode ? "header-dark" : ""}`}>
        ...
        <div className='header-container'>
            <a href="/" className="logo-link" onClick={(event) => { navigation(event, "HomeAbout"); }}><img className="logo" src={Logo} alt="Abhinav Choudhary in white shirt with orange strips."/></a>
